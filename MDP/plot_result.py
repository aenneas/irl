...
def plot_result(filenames):
    for filename in filenames:
        ...
        experiments = {128: np.zeros(10), 64:np.zeros(10), 32: np.zeros(10), 16: np.zeros(10), 8: np.zeros(10), 4: np.zeros(10)}
...
plot_result(["experiments_deep_binaryworld_h5_rep10.pkl"])
